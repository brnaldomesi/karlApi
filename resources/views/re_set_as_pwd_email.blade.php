                    ...
                    <td width="500">
                        <table align="center" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p style="color: #d02e1a;">
                                                    {{\Illuminate\Support\Facades\Lang::get("password.asstNewHelp1")}}
                                                </p>
                                                <p style="color: #d02e1a;">
                                                    {{\Illuminate\Support\Facades\Lang::get("password.asstNewHelp2")}}
                                                </p>
                                            </td>
                                            <td width="10"></td>
                                        </tr>
                            ...
                            <tr>
                                <td align="center">
                                    <hr color="#9b0901">
                                    <p style='font-size:15px;color:#747478;'>{{\Illuminate\Support\Facades\Lang::get("password.asstId")}}</p>
                                    <p style="color: #f2f2f2;text-align:center;font-size:25px;">{{$asstId}}</p>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <br>
                                        {{\Illuminate\Support\Facades\Lang::get("password.asstEmailHelp")}}
